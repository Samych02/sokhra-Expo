        ...
        <View className="flex-row justify-between items-center">
          <View className="flex-row items-center">
            ...
            <View className="flex-col ml-4 h-full">
              <Text className="font-psemibold text-black ">{capitalizeFirstLetter(item.caster.firstName)}</Text>
              <View className="flex-row items-center">
          ...
          <Text className="font-psemibold text-xs text-cgrey self-end">{item.createdAt.split("T")[0]}</Text>
        </View>
        <Text className="font-pregular mx-[52] mt-2">{item.comment}</Text>
      </Card>
  )
}
